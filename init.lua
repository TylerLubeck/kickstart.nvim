...
require('lazy').setup({
...

  {
    ...
    opts = {
      ...
      gitbrowse = {
        ...
        what = 'permalink',
        remote_patterns = {
          { '^git@github%.snooguts%.net:(.*)/(.*)%.git$', 'https://github.snooguts.net/%1/%2' },
          { '^https://github%.snooguts$.net/(.*)/(.*)%.git$', 'https://github.snooguts.net/%1/%2' },
        },
        url_patterns = {
          ['github.snooguts.net'] = {
  ...
  },
  {
    ...
    ft = { 'markdown' },
    keys = {
      { '<leader>mt', '<cmd>Markview Toggle<cr>', desc = '[M]arkdown [t]oggle' },
    },
  },
  {
